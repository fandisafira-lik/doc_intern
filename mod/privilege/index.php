          ...
          <div class="container">
            ...
            <!-- <div class="row"> -->
              <select id="view_rc" class="js-example-basic-multiple form-control f-14" name="view_rc[]" multiple="multiple">
                <?php
                  $query = "SELECT v.*, mk.keynum_karyawan, mru.userlog from [200.200.200.222\SQL2008R2].[dbLUCKY].dbo.v_emp_position v
                ...
                ?>
                <option value="<?=$row['keynum_karyawan'];?>"><?=$row['first_name']." ".$row['LAST_NAME']?></option>
